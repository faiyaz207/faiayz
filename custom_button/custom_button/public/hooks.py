...
after_install = "custom_button.setup.after_install"
before_uninstall = "custom_button.setup.before_uninstall"
...
# ---------------------
# This allows you to modify the request data before document creation

# before_insert = "custom_button.utils.before_insert"

# Request After Insert
# --------------------
# This allows you to modify the request data after document creation

# after_insert = "custom_button.utils.after_insert"
